...
class OrderItem(models.Model):
    order = models.ForeignKey(Order, raoated_name='items', on_delete=models.CASCADE)
    product = models.ForeignKey(Product, ralated_name='order_item', on_delete=models.CASCADE)
